...
> **Important:** this repository is a **public 9,295-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,034 domains** on the canonical page below.

**Public extract:** 9,295 rows · **Live catalog:** 5,622,034 domains
...
- `stream.csv` — public CSV extract (9,295 rows)
- `stream.json` — public JSON extract (9,295 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,295-row public sample | 5,622,034 live domains                           |
...
> Unique Domains. *Available .STREAM One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
