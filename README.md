# Available .STREAM One-Word Domains (5,622,034)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C294%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C034%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,294-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,034 domains** on the canonical page below.

**Public extract:** 9,294 rows · **Live catalog:** 5,622,034 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/stream?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_stream_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/stream?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_stream_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./stream.csv">CSV</a> / <a href="./stream.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_stream_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_stream_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .STREAM search](https://unique.domains/domains/tld/stream?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_stream_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .STREAM search](https://unique.domains/domains/tld/stream?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_stream_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./stream.csv) or [Download JSON](./stream.json)
...
- `stream.csv` — public CSV extract (9,294 rows)
- `stream.json` — public JSON extract (9,294 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,294-row public sample | 5,622,034 live domains                           |
...
| ----------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------------- |
| advance.stream    | available | $9.98     | —             | 110            | 33     | 7      | namecheap                                                 |
| mini.stream       | resell    | —         | —             | 70             | 70     | 4      | Porkbun                                                   |
| nationwide.stream | premium   | $125      | $37.99        | 76             | 66     | 10     | name.com                                                  |
| curative.stream   | available | $9.98     | —             | 92             | 27     | 8      | namecheap                                                 |
| prompt.stream     | resell    | —         | —             | 114            | 68     | 6      | NameSilo, LLC                                             |
| seventeen.stream  | premium   | $437.50   | $62.50        | 84             | 62     | 9      | name.com                                                  |
...
| business.stream   | premium   | $3,250    | $130          | 100            | 54     | 8      | namecheap                                                 |
...
> Unique Domains. *Available .STREAM One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
